                ...
                <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu"
                    ...
                    <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item"> <a class="nav-link d-flex align-items-center gap-2" href="/about"> <svg
                                        class="bi" aria-hidden="true">
                                        <use xlink:href="#file-earmark"></use>
                                    </svg>
                                    About
                                </a> </li>
                            <li class="nav-item"> <a class="nav-link d-flex align-items-center gap-2" href="/contact"> <svg
                                        class="bi" aria-hidden="true">
                                        <use xlink:href="#cart"></use>
                                    </svg>
                                   Contact
                                </a> </li>
                            <li class="nav-item"> <a class="nav-link d-flex align-items-center gap-2" href="/photo"> <svg
                                        class="bi" aria-hidden="true">
